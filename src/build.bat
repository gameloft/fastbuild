...
cd "%CUR_DIR%"
xcopy /y %CUR_DIR%\tmp\x64-Release\Tools\FBuild\FBuildApp\FBuild.exe %CUR_DIR%\..\bin\FBuild.exe*
xcopy /y %CUR_DIR%tmp\x64-Release\Tools\FBuild\FBuildWorker\FBuildWorker.exe %CUR_DIR%\..\bin\FBuildWorker.exe*

xcopy /y %CUR_DIR%\tmp\x64-Release\Tools\FBuild\FBuildApp\FBuild.exe %CUR_DIR%\Bin\Windows-x64\FBuild.exe*
