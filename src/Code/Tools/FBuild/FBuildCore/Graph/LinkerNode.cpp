...
bool LinkerNode::CanUseResponseFile() const
{
        ...
        return ( GetFlag( LINK_FLAG_MSVC ) || GetFlag( LINK_FLAG_GCC ) || GetFlag( LINK_FLAG_SNC ) || GetFlag( LINK_FLAG_ORBIS_LD ) || GetFlag( LINK_FLAG_GREENHILLS_ELXR ) || GetFlag( LINK_FLAG_CODEWARRIOR_LD ) || GetFlag(LINK_FLAG_CLANG) ); //[GL] Add LINK_FLAG_CLANG
    #else
        return false;
    #endif
}
